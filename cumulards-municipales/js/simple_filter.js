...
function filterInit(donnees) {
  ...
  var filter_callbacks = {
    after_filter: function(result){
          ...
          // Strippper l'adresse pour récupérer le code embed du snippet
          /(.*)index.html/.exec(window.location);
          var adressesnippet = RegExp.$1+"snippet/index.html"+window.parent.location.hash;

          console.log(adressesnippet)

          $("#embedcode").html("&lt;iframe src=&quot;"+adressesnippet+"&quot; width=&quot;534&quot; height=&quot;515&quot; frameborder=&quot;0&quot; &gt;&lt;/iframe&gt;");
